...
def getMessages() :
	...
	with open(file, 'a') as file:
		for message in jsonData:
			...
			currentTimeStamp = currentTimeStamp.replace(tzinfo=pytz.timezone('GMT'))  # Set timezone to GMT
			currentTimeStamp = currentTimeStamp.astimezone(pytz.timezone('US/Eastern'))
